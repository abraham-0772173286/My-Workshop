...
$navItems[] = ['page' => 'dashboard', 'href' => 'index.php', 'icon' => 'bi-speedometer2', 'label' => 'Dashboard'];

// Core operations - available to all roles
$navItems[] = ['page' => 'repair_jobs', 'href' => 'repair_jobs.php', 'icon' => 'bi-clipboard2-check', 'label' => 'Repair Jobs'];
$navItems[] = ['page' => 'customers', 'href' => 'customers.php', 'icon' => 'bi-people', 'label' => 'Customers'];
$navItems[] = ['page' => 'vehicles', 'href' => 'vehicles.php', 'icon' => 'bi-car-front', 'label' => 'Vehicles'];

// Financial operations - available to all roles but with different permissions
$navItems[] = ['page' => 'payments', 'href' => 'models/payment.php', 'icon' => 'bi-cash-stack', 'label' => 'Payments'];
$navItems[] = ['page' => 'receipts', 'href' => '#', 'icon' => 'bi-receipt', 'label' => 'Receipts', 'arrow' => true];
...
// Admin only features
if ($userRole === 'admin') {
    $navItems[] = ['page' => 'settings', 'href' => 'models/settings.php', 'icon' => 'bi-gear', 'label' => 'Settings'];
    $navItems[] = ['page' => 'users', 'href' => 'models/user_management.php', 'icon' => 'bi-people-fill', 'label' => 'User Management'];
    $navItems[] = ['page' => 'security', 'href' => 'models/security_monitor.php', 'icon' => 'bi-shield-exclamation', 'label' => 'Security Monitor'];
}
?>
<aside class="garage-sidebar" id="garageSidebar">
  ...
  <nav class="nav-sidebar">
    ...
    <div class="sidebar-footer">
        ...
        Logged in as <?= htmlspecialchars($user['name'] ?? 'User', ENT_QUOTES) ?>
