...
<body class="layout-fixed sidebar-expand-lg bg-body-tertiary">
  ...
  <div class="app-wrapper">
    ...
    <aside class="garage-sidebar" id="garageSidebar" aria-label="Main navigation">
      ...
      <nav class="nav-sidebar">
        ...
        <div class="nav-item"><a href="#" class="nav-link" data-panel="repair-jobs"><i class="bi bi-speedometer2"></i><span data-i18n="dashboard">Dashboard</span></a></div>
        <div class="nav-item"><a href="#" class="nav-link active" data-panel="repair-jobs"><i class="bi bi-clipboard2-check"></i><span data-i18n="repairJobs">Repair Jobs</span><i class="bi bi-chevron-right nav-arrow"></i></a></div>
        <div class="nav-item"><a href="#" class="nav-link" data-panel="customers"><i class="bi bi-people"></i><span data-i18n="customers">Customers</span><i class="bi bi-chevron-right nav-arrow"></i></a></div>
    ...
    <main class="app-main">
      ...
      <div class="app-content p-0 m-0">
        ...
        <!-- ═══════════════════════════════ REPAIR JOBS PANEL ═══════════════════════════════ -->
        <div id="panel-repair-jobs" class="app-panel">
        ...
        <div class="card customized-card shadow-sm border-0">
          ...
          <div class="card-body p-4">
            <div id="toolbar" class="mb-4 pb-3 d-flex flex-wrap align-items-center justify-content-between gap-3">
              ...
              <div class="d-flex gap-2">
                <button class="btn btn-sm btn-light border" onclick="exportTable('print', table)" title="Branded Print / PDF">
        ...
        <div id="section-invoice" style="display:none;">
          <div class="card customized-card shadow-sm border-0">
            <div class="card-header bg-white py-3">
              <div>
                <h3 class="card-title fw-bold mb-0">Invoice</h3>
              </div>
            </div>
            <div class="card-body p-0">
              <iframe src="../shengchi-invoice/index.php" style="width:100%; height:85vh; border:0;"></iframe>
            </div>
          </div>
        </div>
              ...
              <form id="repairJobForm">
                <div class="modal-body p-4">
                  <div class="row g-3">
                    ...
                    <div class="col-md-6"><label class="form-label small fw-semibold" data-i18n="dateReceived">Date received <span class="text-danger">*</span></label><input class="form-control" type="date" name="date_received" id="date_received" required></div>
      ...
      </div><!-- /#panel-repair-jobs -->

        <!-- ═══════════════════════════════ CUSTOMERS PANEL ═══════════════════════════════ -->
        <div id="panel-customers" class="app-panel" style="display:none;">
          <style>
            .cust-avatar {
              width: 40px; height: 40px; border-radius: 10px;
              display: flex; align-items: center; justify-content: center;
              font-weight: 800; font-size: 16px; color: #fff;
              background: linear-gradient(135deg, #4015bf, #7c3aed);
              flex-shrink: 0;
            }
          </style>
          ...
          <div class="card shadow-sm border-0">
            <div class="card-header bg-white py-3">
              <div class="d-flex justify-content-between align-items-center">
                <div>
                  <h3 class="card-title fw-bold mb-0" data-i18n="customersRegister">Customers</h3>
                  <small class="text-muted" data-i18n="customersSubtitle">Auto-populated from repair job registrations</small>
                </div>
                <div class="d-flex gap-2">
                  <button class="btn btn-sm btn-light border" onclick="exportTable('print', custTable)" title="Branded Print / PDF"><i class="fa fa-print"></i></button>
                  <div class="dropdown">
                    <button class="btn btn-sm btn-light border dropdown-toggle" type="button" data-bs-toggle="dropdown">
                      <i class="bi bi-download me-1"></i> <span data-i18n="export">Export</span>
                    </button>
                    <ul class="dropdown-menu dropdown-menu-end shadow">
                      <li><a class="dropdown-item small" href="#" onclick="exportTable('pdf', custTable)"><i class="fa fa-file-pdf text-danger me-2"></i><span data-i18n="pdfDocument">PDF Document</span></a></li>
                      <li><a class="dropdown-item small" href="#" onclick="exportTable('excel', custTable)"><i class="fa fa-file-excel text-success me-2"></i><span data-i18n="excelSpreadsheet">Excel Spreadsheet</span></a></li>
                      <li><a class="dropdown-item small" href="#" onclick="exportTable('csv', custTable)"><i class="fa fa-file-csv text-info me-2"></i><span data-i18n="csvFile">CSV File</span></a></li>
                    </ul>
                  </div>
                </div>
              </div>
              ...
              <div class="table-responsive">
                <table id="customerstable" class="table align-middle w-100">
                  <thead>
                    <tr>
                      <th style="width:30px;"></th>
                      <th data-i18n="customerName">Customer Name</th>
                      <th data-i18n="phoneContact">Contact</th>
                      <th data-i18n="address">Address</th>
                      <th data-i18n="custPlates">Plates</th>
                      <th data-i18n="custTotalJobs">Total Jobs</th>
                      <th data-i18n="custFirstSeen">First Seen</th>
                      <th data-i18n="custLastSeen">Last Seen</th>
                    </tr>
                  </thead>
                </table>
              </div>
          ...
          <!-- Customer detail drawer (right slide-in) -->
          <div class="offcanvas offcanvas-end" tabindex="-1" id="customerDrawer" aria-labelledby="customerDrawerLabel" style="width:480px;">
            <div class="offcanvas-header" style="background:linear-gradient(135deg,#4015bf,#7c3aed);color:#fff;">
              <div>
                <h5 class="offcanvas-title fw-bold" id="customerDrawerLabel">Customer Details</h5>
                <small class="opacity-75" id="drawerSubtitle"></small>
              </div>
              <button type="button" class="btn-close btn-close-white" data-bs-dismiss="offcanvas"></button>
            </div>
            <div class="offcanvas-body p-0">
              <!-- Customer info strip -->
              <div class="p-3 bg-light border-bottom" id="drawerCustomerInfo"></div>
              <!-- Jobs table -->
              <div class="p-3">
                <h6 class="text-uppercase text-muted small fw-bold mb-3" data-i18n="repairHistory">Repair History</h6>
                <div class="table-responsive">
                  <table id="customerJobsTable" class="table table-sm align-middle w-100">
                    <thead class="table-light">
                      <tr>
                        <th data-i18n="jobNo">Job No.</th>
                        <th data-i18n="vehicle">Vehicle</th>
                        <th data-i18n="repairType">Repair Type</th>
                        <th data-i18n="date">Date In</th>
                        <th data-i18n="status">Status</th>
                      </tr>
                    </thead>
                    <tbody id="customerJobsBody">
          ...
          <script>
            ...
            function loadCustomersTable() {
              ...
              custTable = $('#customerstable').DataTable({
                responsive: true,
                processing: true,
                pageLength: 25,
                dom: 'lfrtip',
                buttons: [
                  { extend:'copy',  text:'<i class="fa fa-copy"></i> Copy',  className:'btn btn-secondary btn-flat btn-sm', exportOptions:{columns:':not(:first-child)'} },
                  { extend:'csv',   text:'<i class="fa fa-file-csv"></i> CSV',   className:'btn btn-success btn-flat btn-sm', exportOptions:{columns:':not(:first-child)'} },
                  { extend:'excel', text:'<i class="fa fa-file-excel"></i> Excel', className:'btn btn-success btn-flat btn-sm', exportOptions:{columns:':not(:first-child)'} }
                ],
                ajax: {
                  url: '../classes/Customers.php?f=viewall',
                  dataSrc: ''
                },
                columns: [
                  {
                    data: 'customer_id', orderable: false,
                    render: d => `<div class="form-check"><input class="form-check-input cust-check" type="checkbox" value="${d}"></div>`
                  },
                  {
                    data: 'fullname',
                    render: (d, t, row) => {
                      const initials = d.trim().split(' ').slice(0,2).map(w=>w[0]||'').join('').toUpperCase();
                      return `<div class="d-flex align-items-center gap-2">
                        <div class="cust-avatar">${initials}</div>
                        <div>
                          <div class="fw-bold text-dark">${d}</div>
                          <small class="text-muted">${row.total_vehicles} vehicle${row.total_vehicles != 1 ? 's' : ''}</small>
                        </div>
                      </div>`;
                    }
                  },
                  {
                    data: 'contact',
                    render: d => `<span class="small"><i class="bi bi-telephone me-1 text-muted"></i>${d}</span>`
                  },
                  { data: 'address' },
                  {
                    data: 'plates',
                    render: d => d === '—' ? '<span class="text-muted">—</span>' :
                      d.split(', ').map(p=>`<code class="text-primary fw-bold me-1">${p}</code>`).join('')
                  },
                  {
                    data: 'total_jobs',
              ...
              $('#customerstable tbody').on('click', 'tr', function() {
                ...
                custTable.$('input.cust-check').prop('checked', false);
                $(this).find('input.cust-check').prop('checked', isSelected);

                if (isSelected) {
                  const data = custTable.row(this).data();
                  if (data) {
                    selectedCustomer = data.customer_id;
                    openCustomerDrawer(data);
                  }
                } else {
            ...
            function openCustomerDrawer(data) {
              // Header subtitle
              document.getElementById('drawerSubtitle').textContent = data.contact;
              document.getElementById('customerDrawerLabel').textContent = data.fullname;

              // Info strip
              document.getElementById('drawerCustomerInfo').innerHTML = `
                <div class="row g-2 text-center">
                  <div class="col-4">
                    <div class="fw-bold text-primary fs-5">${data.total_jobs}</div>
                    <small class="text-muted">Repair Jobs</small>
                  </div>
                  <div class="col-4">
                    <div class="fw-bold text-success fs-5">${data.total_vehicles}</div>
                    <small class="text-muted">Vehicles</small>
                  </div>
                  <div class="col-4">
                    <div class="fw-bold text-dark" style="font-size:13px;">${data.last_seen || '—'}</div>
                    <small class="text-muted">Last Visit</small>
                  </div>
                </div>
                <div class="mt-2 text-muted small">
                  <i class="bi bi-geo-alt me-1"></i>${data.address}
                  &nbsp;·&nbsp;
                  <i class="bi bi-calendar3 me-1"></i>Customer since ${data.registered_on}
                </div>`;

              // Clear jobs body and show loading
              const tbody = document.getElementById('customerJobsBody');
              tbody.innerHTML = '<tr><td colspan="5" class="text-center text-muted py-4"><span class="spinner-border spinner-border-sm me-2"></span>Loading...</td></tr>';
              ...
              // Load jobs
              $.getJSON('../classes/Customers.php?f=view_jobs&id=' + data.customer_id, function(jobs) {
                if (!jobs.length) {
                  tbody.innerHTML = '<tr><td colspan="5" class="text-center text-muted py-4">No repair history found.</td></tr>';
                  return;
                }
                tbody.innerHTML = jobs.map(j => `
                  <tr>
                    <td><code class="text-primary fw-bold">${j.job_no}</code></td>
                    <td><small><i class="bi bi-car-front me-1 text-muted"></i>${j.vehicle}</small></td>
                    <td><small>${j.repair_type}</small></td>
                    <td><small>${j.date_received}</small></td>
                    <td>${j.status === 'REPAIR DONE'
                      ? '<span class="status-pill status-done"><i class="bi bi-check-circle-fill me-1"></i>DONE</span>'
                      : '<span class="status-pill status-pending"><i class="bi bi-clock-history me-1"></i>PENDING</span>'}</td>
                  </tr>`).join('');
              }).fail(function() {
                tbody.innerHTML = '<tr><td colspan="5" class="text-center text-danger py-3">Failed to load jobs.</td></tr>';
              });
            }
          </script>
        </div><!-- /#panel-customers -->
        ...
        <script>
          (function() {
            function switchPanel(panelId) {
              ...
              document.querySelectorAll('.nav-sidebar .nav-link[data-panel]').forEach(a => {
            ...
            document.addEventListener('DOMContentLoaded', function() {
              document.querySelectorAll('.nav-sidebar .nav-link[data-panel]').forEach(function(link) {
                link.addEventListener('click', function(e) {
                  e.preventDefault();
                  switchPanel(this.dataset.panel);
                });
              });
              // Default: show repair-jobs
              switchPanel('repair-jobs');
            });
          })();
        </script>
  ...
  <script>
    ...
    function exportTable(type, mytable) {
      ...
      switch (type) {
        case 'csv':
          mytable.button('.buttons-csv').trigger();
          break;
        case 'excel':
    ...
    /* ─────────────────────────────────────────────────────────────
       printBranded(dtInstance)
       Generates a Shengchi-branded print window from any DataTable.
       Reads visible column headers + all current data rows.
    ───────────────────────────────────────────────────────────── */
    function printBranded(dtInstance) {
      if (!dtInstance) { toastr.error('Table not ready.'); return; }

      // ── 1. Collect headers (skip checkbox col, strip HTML) ──
      const headers = [];
      dtInstance.columns().header().each(function(th, i) {
        if (i === 0) return; // skip checkbox column
        const text = $(th).text().trim();
        if (text) headers.push(text);
      });

      // ── 2. Collect all data rows (use display order, all pages) ──
      const rows = [];
      dtInstance.rows({ search: 'applied' }).data().each(function(rowData) {
        const cells = [];
        dtInstance.columns().every(function(i) {
          if (i === 0) return; // skip checkbox column
          const header = $(dtInstance.column(i).header()).text().trim();
          if (!header) return;
          // Get the rendered cell value, strip HTML tags
          const rendered = dtInstance.cell(dtInstance.rows({ search: 'applied' }).indexes()[rows.length], i).render('display') || '';
          const plain = String(rendered).replace(/<[^>]*>/g, '').replace(/&amp;/g,'&').replace(/&lt;/g,'<').replace(/&gt;/g,'>').trim();
          cells.push(plain);
        });
        rows.push(cells);
      });

      // Re-collect using a cleaner approach: iterate nodes
      const cleanRows = [];
      dtInstance.rows({ search: 'applied' }).nodes().each(function(tr) {
        const cells = [];
      ...
      _openPrintWindow(headers, cleanRows);
    }

    function _openPrintWindow(headers, rows) {
      // Use URL resolution so the absolute path is correct regardless of subfolder depth
...
<head>
<meta charset="UTF-8">
<title>Shengchi Auto Ltd — Print</title>
<style>
  ...
  * { box-sizing: border-box; }
  ...
  /* ── Header ── */
  .doc-header { display:flex; align-items:center; justify-content:space-between; border-bottom:2px solid #111; padding-bottom:10px; margin-bottom:4px; }
  .doc-header .logo-wrap { display:flex; align-items:center; gap:10px; }
  .doc-header img { width:64px; height:64px; object-fit:contain; }
  .company-name { font-size:17px; font-weight:900; letter-spacing:.3px; margin:0; }
  .company-sub  { font-size:9.5px; color:#444; margin:1px 0 0; line-height:1.4; }
  .doc-meta { text-align:right; font-size:10px; color:#555; line-height:1.7; }
  .doc-meta strong { color:#111; font-size:11px; }
  ...
  table.data-table thead th.num { width:32px; text-align:center; }
  table.data-table tbody tr:nth-child(even) { background: #f5f7ff; }
  table.data-table tbody tr:hover { background: #e8edff; }
  table.data-table tbody td {
    padding: 6px 8px;
    border: 1px solid #d1d5db;
    vertical-align: middle;
  }
  table.data-table tbody td.num { text-align:center; color:#888; font-size:10px; }
...
<div class="doc-header">
  <div class="logo-wrap">
    <img src="${logoSrc}" alt="Shengchi Auto Ltd" onerror="this.style.display='none'">
    <div>
      <p class="company-name">SHENGCHI AUTO LTD</p>
      <p class="company-sub">5 Edinburgh Ave, near Uganda Passport Collection Centre,<br>Kyambogo, Kampala City, Central (CE).</p>
      <p class="company-sub">Contact: +256 777552940 &nbsp;|&nbsp; +256 757063365 &nbsp;|&nbsp; Email: shengchiauto@gmail.com</p>
    </div>
  </div>
  <div class="doc-meta">
    <strong>Printed: ${dateStr} at ${timeStr}</strong><br>
    TIN: [TIN NUMBER]<br>
    VAT: [VAT NUMBER]
  </div>
</div>
...
<table class="data-table">
  ...
  <tbody>
    ${tbodyHtml || '<tr><td colspan="99" style="text-align:center;padding:20px;color:#888;">No records found.</td></tr>'}
  </tbody>
  <tfoot>
    <tr>
      <td colspan="${headers.length + 1}">Total records: <strong>${rows.length}</strong></td>
    </tr>
  </tfoot>
</table>

<div class="sig-strip">
  <div class="sig-block"><div style="height:40px;"></div><div class="sig-line">Prepared by</div></div>
  <div class="sig-block"><div style="height:40px;"></div><div class="sig-line">Reviewed by</div></div>
  <div class="sig-block"><div style="height:40px;"></div><div class="sig-line">Authorized by</div></div>
</div>

<div class="doc-footer">
  <span>SHENGCHI AUTO LTD &mdash; Confidential</span>
  <span>Printed ${dateStr} ${timeStr} &mdash; Page 1</span>
</div>
      ...
      if (!win) { toastr.error('Pop-up blocked. Please allow pop-ups for this site.'); return; }
